...
<# Begin: DataSource "exchange-on-premises-sharedmailbox-manage-sendas-permissions | Exchange-On-Premises-Get-Current-Send-As-Users" #>
$tmpPsScript = @'
...
try{
    ...
    $permissions = Get-ADPermission @getMailboxesSplatParams | Where-Object {($_.ExtendedRights -like "*send*") -and -not ($_.User -like "*NT AUTHORITY*")} | Select-Object  @{Name="Displayname"; Expression={(Get-Recipient $_.user.ToString()).Displayname.ToString()}}, @{Name="Samaccountname"; Expression={(Get-Recipient $_.user.ToString()).sAMAccountName.ToString()}}
    Write-Information "Queried shared mailboxes that match Name [$($mailbox.displayName)]. Result sendas users count: $(($permissions | Measure-Object).Count)"
    
    $permissions = $permissions | Sort-Object -Property Displayname
    foreach($permission in $permissions)
    {        
        $returnObject = @{SamAccountName=$permission.Samaccountname;Name=$permission.Displayname;}
...
exchange-on-premises-sharedmailbox-manage-sendas-permissions | Exchange-On-Premises-Get-Current-Send-As-Users
'@ 
...
<# End: DataSource "exchange-on-premises-sharedmailbox-manage-sendas-permissions | Exchange-On-Premises-Get-Current-Send-As-Users" #>

<# Begin: DataSource "exchange-on-premises-sharedmailbox-manage-sendas-permissions | Exchange-On-Premises-Get-All-Users" #>
$tmpPsScript = @'
# Build filter
...
exchange-on-premises-sharedmailbox-manage-sendas-permissions | Exchange-On-Premises-Get-All-Users
'@ 
...
<# End: DataSource "exchange-on-premises-sharedmailbox-manage-sendas-permissions | Exchange-On-Premises-Get-All-Users" #>

<# Begin: DataSource "exchange-on-premises-sharedmailbox-manage-sendas-permissions | Exchange-On-Premises-Get-Sharedmailbox-Wildcard-Name-Alias" #>
$tmpPsScript = @'
# Variables configured in form
...
'@ 
$tmpModel = @'
[{"key":"Guid","type":0},{"key":"DisplayName","type":0},{"key":"Name","type":0},{"key":"Alias","type":0},{"key":"PrimarySmtpAddress","type":0},{"key":"EmailAddresses","type":0},{"key":"UserPrincipalName","type":0},{"key":"RecipientTypeDetails","type":0},{"key":"HiddenFromAddressListsEnabled","type":0},{"key":"DistinguishedName","type":0}]
'@ 
$tmpInput = @'
...
exchange-on-premises-sharedmailbox-manage-sendas-permissions | Exchange-On-Premises-Get-Sharedmailbox-Wildcard-Name-Alias
'@ 
...
<# End: DataSource "exchange-on-premises-sharedmailbox-manage-sendas-permissions | Exchange-On-Premises-Get-Sharedmailbox-Wildcard-Name-Alias" #>
<# End: HelloID Data sources #>

<# Begin: Dynamic Form "Exchange On-Premises - Sharedmailbox - Manage send as permissions" #>
$tmpSchema = @"
[{"label":"Search Sharedmailbox","fields":[{"key":"searchMailbox","templateOptions":{"label":"Search Sharedmailbox","placeholder":""},"type":"input","summaryVisibility":"Show","requiresTemplateOptions":true,"requiresKey":true,"requiresDataSource":false},{"key":"gridMailbox","templateOptions":{"label":"Select Sharedmailbox","required":true,"grid":{"columns":[{"headerName":"Display Name","field":"DisplayName"},{"headerName":"Primary Smtp Address","field":"PrimarySmtpAddress"},{"headerName":"Email Addresses","field":"EmailAddresses"},{"headerName":"Alias","field":"Alias"},{"headerName":"Recipient Type Details","field":"RecipientTypeDetails"}],"height":300,"rowSelection":"single"},"dataSourceConfig":{"dataSourceGuid":"$dataSourceGuid_0","input":{"propertyInputs":[{"propertyName":"searchValue","otherFieldValue":{"otherFieldKey":"searchMailbox"}}]}},"allowCsvDownload":true,"useFilter":true},"type":"grid","summaryVisibility":"Show","requiresTemplateOptions":true,"requiresKey":true,"requiresDataSource":true}]},{"label":"Mailbox Permissions","fields":[{"key":"sendasList","templateOptions":{"label":"User(s) to manage send as permission","required":false,"filterable":true,"useDataSource":true,"dualList":{"options":[{"guid":"75ea2890-88f8-4851-b202-626123054e14","name":"Apple"},{"guid":"0607270d-83e2-4574-9894-0b70011b663f","name":"Pear"},{"guid":"1ef6fe01-3095-4614-a6db-7c8cd416ae3b","name":"Orange"}],"optionKeyProperty":"SamAccountName","optionDisplayProperty":"Name"},"destinationDataSourceConfig":{"dataSourceGuid":"$dataSourceGuid_1","input":{"propertyInputs":[{"propertyName":"selectedMailbox","otherFieldValue":{"otherFieldKey":"gridMailbox"}}]}},"dataSourceConfig":{"dataSourceGuid":"$dataSourceGuid_2","input":{"propertyInputs":[]}}},"type":"duallist","summaryVisibility":"Show","sourceDataSourceIdentifierSuffix":"source-datasource","destinationDataSourceIdentifierSuffix":"destination-datasource","requiresTemplateOptions":true,"requiresKey":true,"requiresDataSource":false}]}]
"@ 

$dynamicFormGuid = [PSCustomObject]@{} 
$dynamicFormName = @'
Exchange On-Premises - Sharedmailbox - Manage send as permissions
'@ 
...
'@
$tmpTask = @'
{"name":"Exchange On-Premises - Sharedmailbox - Manage sendas permissions","script":"# variables configured in form\r\n$mailbox = $form.gridMailbox\r\n$usersToAdd = $form.sendasList.leftToRight\r\n$usersToRemove = $form.sendasList.rightToLeft\r\n\r\n# Global variables\r\n# Outcommented as these are set from Global Variables\r\n# $ExchangeConnectionUri = \"\"\r\n# $ExchangeAdminUsername = \"\"\r\n# $ExchangeAdminPassword = \"\"\r\n\r\n# Fixed values\r\n$commands = @(\r\n    \"Get-Mailbox\",    \r\n    \"Add-ADPermission\",\r\n    \"Remove-ADPermission\"\r\n)\r\n\r\n# Enable TLS1.2\r\n[System.Net.ServicePointManager]::SecurityProtocol = [System.Net.ServicePointManager]::SecurityProtocol -bor [System.Net.SecurityProtocolType]::Tls12\r\n\r\n# Set debug logging\r\n$VerbosePreference = \"SilentlyContinue\"\r\n$InformationPreference = \"Continue\"\r\n$WarningPreference = \"Continue\"\r\n\r\ntry {       \r\n    # Create credentials\r\n    $actionMessage = \"creating credentials object\"\r\n    \r\n    $securePassword = ConvertTo-SecureString -String $ExchangeAdminPassword -AsPlainText -Force\r\n    $credential = [System.Management.Automation.PSCredential]::new($ExchangeAdminUsername, $securePassword)\r\n    \r\n    Write-Verbose \"Created credentials for user [$ExchangeAdminUsername]\"\r\n\r\n    # Connect to Exchange On-Premises\r\n    # Docs: https://learn.microsoft.com/en-us/powershell/exchange/connect-to-exchange-servers-using-remote-powershell\r\n    $actionMessage = \"connecting to Exchange On-Premises\"\r\n\r\n    $sessionOptionParams = @{\r\n        SkipCACheck         = $false\r\n        SkipCNCheck         = $false\r\n        SkipRevocationCheck = $false\r\n    }\r\n\r\n    $sessionOption = New-PSSessionOption @sessionOptionParams\r\n\r\n    $sessionParams = @{\r\n        Authentication    = \u0027Default\u0027\r\n        ConfigurationName = \u0027Microsoft.Exchange\u0027\r\n        Credential        = $credential\r\n        ConnectionUri     = $ExchangeConnectionUri\r\n        SessionOption     = $sessionOption\r\n        ErrorAction       = \"Stop\"\r\n    }\r\n\r\n    $exchangeSession = New-PSSession @sessionParams\r\n    $null = Import-PSSession -Session $exchangeSession -DisableNameChecking -AllowClobber -CommandName $commands -ErrorAction Stop\r\n\r\n    # Send initial audit log\r\n    $Log = @{\r\n        Action            = \"UpdateResource\" # optional. ENUM (undefined = default) \r\n        System            = \"Exchange On-Premises\" # optional (free format text) \r\n        Message           = \"Successfully connected to Exchange using URI [$ExchangeConnectionUri]\" # required (free format text) \r\n        IsError           = $false # optional. Elastic reporting purposes only. (default = $false. $true = Executed action returned an error) \r\n        TargetDisplayName = $ExchangeConnectionUri # optional (free format text) \r\n        TargetIdentifier  = $([string]$exchangeSession.InstanceId) # optional (free format text) \r\n    }\r\n    Write-Information -Tags \"Audit\" -MessageData $log\r\n\r\n    # Add Send As Permissions\r\n    if ($usersToAdd.count -gt 0) {\r\n        Write-Information \"Starting to grant permission [SendAs] on mailbox [$($mailbox.DisplayName)]\"\r\n        \r\n        foreach ($user in $usersToAdd) {\r\n            try {                    \r\n                $actionMessage = \"granting permission [SendAs] to mailbox [$($mailbox.DisplayName) ($($mailbox.PrimarySmtpAddress))] for user [$($user.userPrincipalName) ($($user.Guid))]\"      \r\n                $sendAsPermissionSplatParams = @{\r\n                    Identity     = $($mailbox.DistinguishedName)\r\n                    User      = $($user.sAMAccountName)\r\n                    AccessRights = \"ExtendedRight\"\r\n                    ExtendedRights = \"Send As\"\r\n                    Confirm      = $false\r\n                    ErrorAction  = \"Stop\"\r\n                } \r\n                $addSendAsPermission = Add-ADPermission @sendAsPermissionSplatParams\r\n\r\n                Write-Information \"Granting access rights [SendAs] on mailbox [$($mailbox.DisplayName)] for [$($user.DisplayName)] successfully.\"\r\n                $Log = @{\r\n                    Action            = \"GrantMembership\" # optional. ENUM (undefined = default) \r\n                    System            = \"Exchange On-Premises\" # optional (free format text) \r\n                    Message           = \"Granting access rights [SendAs] on mailbox [$($mailbox.DisplayName)] for [$($user.DisplayName)] successfully.\" # required (free format text) \r\n                    IsError           = $false # optional. Elastic reporting purposes only. (default = $false. $true = Executed action returned an error) \r\n                    TargetDisplayName = $($mailbox.DisplayName) # optional (free format text) \r\n                    TargetIdentifier  = $([string]$mailbox.Guid) # optional (free format text) \r\n                }\r\n                #send result back  \r\n                Write-Information -Tags \"Audit\" -MessageData $log \r\n            }\r\n            catch {\r\n                $ex = $PSItem\r\n                if (-not [string]::IsNullOrEmpty($ex.Exception.Message)) {\r\n                    $warningMessage = \"Error at Line [$($ex.InvocationInfo.ScriptLineNumber)]: $($ex.InvocationInfo.Line). Error: $($ex.Exception.Message)\"\r\n                    $auditMessage = \"Error $($actionMessage). Error: $($ex.Exception.Message)\"\r\n                }\r\n                else {\r\n                    $warningMessage = \"Error at Line [$($ex.InvocationInfo.ScriptLineNumber)]: $($ex.InvocationInfo.Line). Error: $($ex.Exception)\"\r\n                    $auditMessage = \"Error $($actionMessage). Error: $($ex.Exception)\"\r\n                }\r\n\r\n                Write-Error \"Error granting access rights [SendAs] for $($user.DisplayName) on mailbox [$($mailbox.DisplayName)]. Error: $($_.Exception.Message)\" \r\n                $Log = @{\r\n                    Action            = \"GrantMembership\" # optional. ENUM (undefined = default) \r\n                    System            = \"Exchange On-Premises\" # optional (free format text) \r\n                    Message           = \"Error granting access rights [SendAs] to $($user.DisplayName) on mailbox [$($mailbox.DisplayName)]\" # required (free format text) \r\n                    IsError           = $true # optional. Elastic reporting purposes only. (default = $false. $true = Executed action returned an error) \r\n                    TargetDisplayName = $($mailbox.DisplayName) # optional (free format text) \r\n                    TargetIdentifier  = $([string]$mailbox.Guid) # optional (free format text) \r\n                }\r\n                #send result back  \r\n                Write-Information -Tags \"Audit\" -MessageData $log\r\n                Write-Warning $warningMessage\r\n                Write-Error $auditMessage\r\n            }\r\n            break\r\n        }\r\n    }\r\n\r\n    # Remove Send As Permissions\r\n    if ($usersToRemove.Count -gt 0) {\r\n        Write-Information \"Starting to revoke permission [SendAs] on mailbox [$($mailbox.DisplayName)]\"\r\n        \r\n        foreach ($user in $usersToRemove) {\r\n            try {\r\n                $actionMessage = \"revoking permission [SendAs] on mailbox [$($mailbox.DisplayName) ($($mailbox.PrimarySmtpAddress))] for user [$($user.userPrincipalName) ($($user.Guid))]\"      \r\n                $sendAsPermissionSplatParams = @{\r\n                    Identity     = $($mailbox.DistinguishedName)\r\n                    User      = $($user.sAMAccountName)\r\n                    AccessRights = \"ExtendedRight\"\r\n                    ExtendedRights = \"Send As\"\r\n                    Confirm      = $false\r\n                    ErrorAction  = \"Stop\"\r\n                } \r\n                $removeSendAsPermission = Remove-ADPermission @sendAsPermissionSplatParams\r\n            \r\n                Write-Information \"Revoking access rights [SendAs] on mailbox [$($mailbox.DisplayName)] for [$($user.DisplayName)] successfully\"\r\n                $Log = @{\r\n                    Action            = \"RevokeMembership\" # optional. ENUM (undefined = default) \r\n                    System            = \"Exchange On-Premises\" # optional (free format text) \r\n                    Message           = \"Revoking access rights [SendAs] on mailbox [$($mailbox.DisplayName)] for [$($user.DisplayName)] successfully.\" # required (free format text) \r\n                    IsError           = $false # optional. Elastic reporting purposes only. (default = $false. $true = Executed action returned an error) \r\n                    TargetDisplayName = $($mailbox.DisplayName) # optional (free format text) \r\n                    TargetIdentifier  = $([string]$mailbox.Guid) # optional (free format text) \r\n                }\r\n                #send result back  \r\n                Write-Information -Tags \"Audit\" -MessageData $log\r\n            }\r\n            catch {\r\n                $ex = $PSItem\r\n                if (-not [string]::IsNullOrEmpty($ex.Exception.Message)) {\r\n                    $warningMessage = \"Error at Line [$($ex.InvocationInfo.ScriptLineNumber)]: $($ex.InvocationInfo.Line). Error: $($ex.Exception.Message)\"\r\n                    $auditMessage = \"Error $($actionMessage). Error: $($ex.Exception.Message)\"\r\n                }\r\n                else {\r\n                    $warningMessage = \"Error at Line [$($ex.InvocationInfo.ScriptLineNumber)]: $($ex.InvocationInfo.Line). Error: $($ex.Exception)\"\r\n                    $auditMessage = \"Error $($actionMessage). Error: $($ex.Exception)\"\r\n                }\r\n\r\n                Write-Error \"Error revoking access rights [SendAs] on mailbox [$($mailbox.DisplayName)] for [$($user.DisplayName)]. Error: $($_.Exception.Message)\"\r\n                $Log = @{\r\n                    Action            = \"RevokeMembership\" # optional. ENUM (undefined = default) \r\n                    System            = \"Exchange On-Premises\" # optional (free format text) \r\n                    Message           = \"Error revoking access rights [SendAs] on mailbox [$($mailbox.DisplayName)] for [$($user.DisplayName)].\" # required (free format text) \r\n                    IsError           = $true # optional. Elastic reporting purposes only. (default = $false. $true = Executed action returned an error) \r\n                    TargetDisplayName = $($mailbox.DisplayName) # optional (free format text) \r\n                    TargetIdentifier  = $([string]$mailbox.Guid) # optional (free format text) \r\n                }\r\n                #send result back  \r\n                Write-Information -Tags \"Audit\" -MessageData $log\r\n                Write-Warning $warningMessage\r\n                Write-Error $auditMessage\r\n            }\r\n            break\r\n        }\r\n    }        \r\n        \r\n}\r\ncatch {\r\n    $ex = $PSItem\r\n    if (-not [string]::IsNullOrEmpty($ex.Exception.Message)) {\r\n        $warningMessage = \"Error at Line [$($ex.InvocationInfo.ScriptLineNumber)]: $($ex.InvocationInfo.Line). Error: $($ex.Exception.Message)\"\r\n        $auditMessage = \"Error $($actionMessage). Error: $($ex.Exception.Message)\"\r\n    }\r\n    else {\r\n        $warningMessage = \"Error at Line [$($ex.InvocationInfo.ScriptLineNumber)]: $($ex.InvocationInfo.Line). Error: $($ex.Exception)\"\r\n        $auditMessage = \"Error $($actionMessage). Error: $($ex.Exception)\"\r\n    }\r\n\r\n    # Send error audit log to HelloID\r\n    $Log = @{\r\n        Action            = \"UpdateResource\" # optional. ENUM (undefined = default) \r\n        System            = \"Exchange On-Premises\" # optional (free format text) \r\n        Message           = $auditMessage # required (free format text) \r\n        IsError           = $true # optional. Elastic reporting purposes only. (default = $false. $true = Executed action returned an error) \r\n        TargetDisplayName = $($mailbox.DisplayName) # optional (free format text) \r\n        TargetIdentifier  = $([string]$mailbox.Guid) # optional (free format text) \r\n    }\r\n    \r\n    Write-Information -Tags \"Audit\" -MessageData $log\r\n    Write-Warning $warningMessage\r\n    Write-Error $auditMessage\r\n}\r\nfinally {\r\n    # Disconnect from Exchange\r\n    # Docs: https://learn.microsoft.com/en-us/powershell/module/microsoft.powershell.core/remove-pssession\r\n    if ($null -ne $exchangeSession) {\r\n        try {\r\n            $deleteExchangeSessionSplatParams = @{\r\n                Session     = $exchangeSession\r\n                Confirm     = $false\r\n                ErrorAction = \"Stop\"\r\n            }\r\n            $null = Remove-PSSession @deleteExchangeSessionSplatParams\r\n\r\n            # Send disconnect audit log\r\n            $Log = @{\r\n                Action            = \"UpdateResource\" # optional. ENUM (undefined = default) \r\n                System            = \"Exchange On-Premises\" # optional (free format text) \r\n                Message           = \"Successfully disconnected from Exchange using URI [$ExchangeConnectionUri]\" # required (free format text) \r\n                IsError           = $false # optional. Elastic reporting purposes only. (default = $false. $true = Executed action returned an error) \r\n                TargetDisplayName = $ExchangeConnectionUri # optional (free format text) \r\n                TargetIdentifier  = $([string]$exchangeSession.InstanceId) # optional (free format text) \r\n            }\r\n            Write-Information -Tags \"Audit\" -MessageData $log\r\n        }\r\n        catch {\r\n            Write-Warning \"Failed to disconnect from Exchange using URI [$ExchangeConnectionUri]. Error: $($_.Exception.Message)\"\r\n        }\r\n    }\r\n}","runInCloud":false}
'@ 
